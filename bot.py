...
# ==================================================================================
API_TOKEN = os.getenv('API_TOKEN', '8660518781:AAHYMN6czwBKb0B2Ph-IZikOxHvyv-PCVQc')
ADMIN_ID = 7750325804
SECONDARY_ADMIN_ID = 7931109296
API_ID = int(os.getenv('API_ID', 34665549))
API_HASH = os.getenv('API_HASH', '9b8c814bdbeddcb2855773c5be6b5492')
TARGET_BOT = os.getenv('TARGET_BOT', '@ResetFluoriteKeys_Bot')
DRIP_RESET_BOT = os.getenv("DRIP_RESET_BOT", "@ResetDrip_bot")
CONTACT_USERNAME = os.getenv('CONTACT_USERNAME', '@DRIFTxCHEAT')
...
PRIMARY_ADMIN_ID = 7750325804 # هذا هو الآيدي الثابت للبوت الأول
